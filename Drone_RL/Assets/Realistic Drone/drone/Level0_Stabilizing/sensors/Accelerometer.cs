...
public class Accelerometer : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        LocalLinearVelocity = droneSettings.setZeroIflessThan(
            Quaternion.AngleAxis(45,transform.up) * transform.InverseTransformDirection(transform.GetComponent<Rigidbody>().linearVelocity), 
            0.0001f);
        ...
        LV = droneSettings.setZeroIflessThan(transform.GetComponent<Rigidbody>().linearVelocity, 0.0001f);
